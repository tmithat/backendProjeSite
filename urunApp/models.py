...
class Reservation(models.Model):
    ...
    resim = models.FileField(("resim"), upload_to="uploads", max_length=100, null=True, blank=True)
    title = models.CharField(("Adı"), max_length=50, null=True)
    aciklama = models.CharField(("Aciklama"), max_length=50, null=True)
    aciklama2 = models.CharField(("Aciklama2"), max_length=50, null=True)
    tel = models.CharField(("Telefon No"), max_length=50, null=True, blank=True)
    

    def resimControl(self):
        if self.resim:
            return self.resim
        else:
            return "static/public/no-image.jpg"
